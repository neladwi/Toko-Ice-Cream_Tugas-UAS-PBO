...
public class Start_page extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("STXingkai", 1, 100)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 255, 255));
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ice cream/eskrim28.png"))); // NOI18N
        ...
        jPanel3.setFont(new java.awt.Font("SimSun", 0, 12)); // NOI18N
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
             JOptionPane.showMessageDialog(this,"Kolom tidak boleh kosong. Mohon masukkan kembali informasi pengguna Anda");
        }
        else
        {
            if(select.equals("Admin"))
            {
                ...
                {
                    JOptionPane.showMessageDialog(this,"Username tidak ditemukan atau password salah. Mohon cek kembali informasi pengguna Anda!");
                }
               } catch (Exception ex) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String select=jComboBox1.getSelectedItem().toString();
         ...
         {
             JOptionPane.showMessageDialog(this,"Password dan confirm password tidak sesuai. Mohon cek kembali");
         }
         else if(select.equals("Choose"))
         {
             JOptionPane.showMessageDialog(this,"Mohon pilih antara Admin atau Customer");
         }
         else
         {  
             if(select.equals("Admin"))
